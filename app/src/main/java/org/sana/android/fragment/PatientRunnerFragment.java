    ...
    class CreatePatientTask extends ProcedureLoaderTask {
        ...
        protected ProcedureLoadResult doInBackground(ProcedureLoadRequest... params) {
            ...
            if (Uris.isEmpty(uSubject)) {
                ...
                mPatient.setLMD(new Date());
                mPatient.setMarital_status("SINGLE");
                mPatient.setContraceptive_use("No");
                mPatient.setEducation_level("Primary_level");
                mPatient.setContraceptive_use("No");
                mPatient.setANC_status("");
               // mPatient.setANC_visit(new Date());
                mPatient.setAMBULANCE_need("No");
                mPatient.setAMBULANCE_response("No");
                mPatient.setEDD("");
                mPatient.setreceive_sms("No");
                mPatient.setCUG_status("No");
                mPatient.setBleeding("No");
                mPatient.setBlurred_vision("No");
                mPatient.setSwollen_feet("No");
                mPatient.setFever("No");
